...
typedef struct
{
  ...
  __IO uint32_t ICR;  /* Clear status flags */
} MIDI_t;
...
static const uint8_t MIDI_DIV = (SYS_FREQ/(31250*16)-1); /*!< 31250 divisor */

/* Control register */
#define MIDI_CR_DIV_Pos   (0U)
#define MIDI_CR_DIV_Msk   (0x7FFUL << MIDI_CR_DIV_Pos)
#define MIDI_CR_DIV       (MIDI_CR_DIV_Msk)

/* Status register */
#define MIDI_SR_RXNE_Pos  (0U)
#define MIDI_SR_RXNE_Msk  (0x1UL << MIDI_SR_RXNE_Pos)
#define MIDI_SR_RXNE      (MIDI_SR_RXNE_Msk)
#define MIDI_SR_FULL_Pos  (1U)
#define MIDI_SR_FULL_Msk  (0x1UL << MIDI_SR_FULL_Pos)
#define MIDI_SR_FULL      (MIDI_SR_FULL_Msk)
#define MIDI_SR_OVF_Pos   (2U)
#define MIDI_SR_OVF_Msk   (0x1UL << MIDI_SR_OVF_Pos)
#define MIDI_SR_OVF       (MIDI_SR_OVF_Msk)
#define MIDI_SR_FERR_Pos  (3U)
#define MIDI_SR_FERR_Msk  (0x1UL << MIDI_SR_FERR_Pos)
#define MIDI_SR_FERR      (MIDI_SR_FERR_Msk)
#define MIDI_SR_LEVEL_Pos (8U)
#define MIDI_SR_LEVEL_Msk (0xFFUL << MIDI_SR_LEVEL_Pos)
#define MIDI_SR_LEVEL     (MIDI_SR_LEVEL_Msk)

/* RX data register */
#define MIDI_RD_DAT_Pos   (0U)
#define MIDI_RD_DAT_Msk   (0xFFUL << MIDI_RD_DAT_Pos)
#define MIDI_RD_DAT       (MIDI_RD_DAT_Msk)

/* Interrupt/status clear register (write 1 to clear) */
#define MIDI_ICR_OVF_Pos  (2U)
#define MIDI_ICR_OVF_Msk  (0x1UL << MIDI_ICR_OVF_Pos)
#define MIDI_ICR_OVF      (MIDI_ICR_OVF_Msk)
#define MIDI_ICR_FERR_Pos (3U)
#define MIDI_ICR_FERR_Msk (0x1UL << MIDI_ICR_FERR_Pos)
#define MIDI_ICR_FERR     (MIDI_ICR_FERR_Msk)
